<h2><a href="https://practice.geeksforgeeks.org/problems/reverse-bits-1611130171/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Reverse Bits</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><div><span style="font-size:18px">Given a non-negative integer&nbsp;<strong>n</strong>. Reverse the bits of&nbsp;<strong>n</strong>&nbsp;and print the number obtained after reversing the bits. </span></div>
