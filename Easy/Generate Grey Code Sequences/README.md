<h2><a href="https://practice.geeksforgeeks.org/problems/generate-grey-code-sequences/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Generate Grey Code Sequences</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N, your task is to complete the function which generates all n-bit <a href="https://en.wikipedia.org/wiki/Gray_code">grey code sequences</a>, a grey code sequence is a sequence such that successive patterns in it differ by one bit.</span></p>
