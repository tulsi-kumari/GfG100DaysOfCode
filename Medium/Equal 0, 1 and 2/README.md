<h2><a href="https://practice.geeksforgeeks.org/problems/equal-0-1-and-23208/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Equal 0, 1 and 2</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given a string <strong>str </strong>of length <strong>N</strong> which consists of only 0, 1 or 2s, count the number of substring which have equal number of 0s, 1s and 2s.</span><br>
&nbsp;</p>
