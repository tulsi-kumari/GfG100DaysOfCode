<h2><a href="https://practice.geeksforgeeks.org/problems/word-break1352/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Word Break</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>A </strong>and a dictionary of n words <strong>B</strong>, find out if A&nbsp;can be segmented into a space-separated sequence of dictionary words.</span></p>
